...
For University of Botswana, Brazil, Sapienza University of Rome, National Tsinghua, and National University of Singapore: Please follow these times as close as possible in your respective time zone. You will be receiving the information on the mystery app as well.

For UC Santa Cruz, UC San Diego, University of Kansas, Clemson/Coastal Carolina University, Mississippi State University, Purdue/Illinois University, and Aalborg Univerity: Expectation is that you will be on call and aligning your hours to the ones here on the West Coast, PDT. If this is an issue, let us know.
...
## Access
We're running on an honor code for remote teams to comply of not having access to their clusters after 5:00pm local time. A suggestion is to use a job scheduler. 