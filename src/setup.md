...
For announcement of application specifications according to the [calendar](./schedule.md) based on your local time zone. Please coordinate with competition organizers.
